...
IMAGE img_selector_btn_idle_right;
IMAGE img_selector_btn_idle_left;
IMAGE img_selector_btn_down_right;
IMAGE img_selector_btn_down_left;
Atlas atlas_miku_idle_right;
...
void load_game_resources() {
	...
	*/
	...
	loadimage(&img_menu_bg, _T("assert/image/menu_bg.bmp"));
	loadimage(&img_selector_bg, _T("assert/image/selector_bg.bmp"));
	loadimage(&img_selector_btn_idle_right, _T("assert/image/selector_btn_idle_right.png"));
	flip_image(&img_selector_btn_idle_right, &img_selector_btn_idle_left);
	loadimage(&img_selector_btn_down_right, _T("assert/image/selector_btn_down_right.png"));
	flip_image(&img_selector_btn_down_right, &img_selector_btn_down_left);

	atlas_miku_idle_right.load_from_file(_T("assert/image/miku_%d.png"), 5);

	mciSendString(_T("open \"assert/sound/bgm.mp3\" alias bgm"), NULL, 0, NULL);

	mciSendString(_T("open \"assert/sound/ui_win.wav\" alias ui_win"), NULL, 0, NULL);
	mciSendString(_T("open \"assert/sound/ui_confirm.wav\" alias ui_confirm"), NULL, 0, NULL);
	mciSendString(_T("open \"assert/sound/ui_switch.wav\" alias ui_switch"), NULL, 0, NULL);
}